...
dislike_form_submit.addEventListener("submit", (e) => {
    if(response_box.innerText.length == 0) {
        e.preventDefault();
        response_box.classList.add('textarea-highlight-empty');
        maxCharacterNotify.innerText = 'Please enter a response.';
    }
})
